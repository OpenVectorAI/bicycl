...
inline CL_HSM_SecretKey<Cryptosystem>::CL_HSM_SecretKey(const Cryptosystem &C,
                                                        const Mpz &v)
    : Mpz(v)
{
...
/* */
template <class Cryptosystem>
inline CL_HSM_PublicKey<Cryptosystem>::CL_HSM_PublicKey(const Cryptosystem &C,
...
template <class Cryptosystem>
inline const QFI &CL_HSM_PublicKey<Cryptosystem>::elt() const
{
  return pk_;
}
...
/* */
template <class Cryptosystem>
inline void CL_HSM_PublicKey<Cryptosystem>::exponentiation(const Cryptosystem &C,
...
/* */
template <class Cryptosystem>
inline CL_HSM_ClearText<Cryptosystem>::CL_HSM_ClearText(const Cryptosystem &C,
                                                        const Mpz &v)
    : Mpz(v)
{
...
/* */
template <class Cryptosystem>
inline CL_HSM_CipherText<Cryptosystem>::CL_HSM_CipherText(const Cryptosystem &C,
                                                          const CL_HSM_PublicKey<Cryptosystem> &pk,
...
/* */
template <class Cryptosystem>
inline const QFI &CL_HSM_CipherText<Cryptosystem>::c1() const
{
  return c1_;
}
...
/* */
template <class Cryptosystem>
inline const QFI &CL_HSM_CipherText<Cryptosystem>::c2() const
{
  return c2_;
}

template <class Cryptosystem>
inline QFI &CL_HSM_CipherText<Cryptosystem>::c1()
{
  return c1_;
}
...
/* */
template <class Cryptosystem>
inline QFI &CL_HSM_CipherText<Cryptosystem>::c2()
{
  return c2_;
}
